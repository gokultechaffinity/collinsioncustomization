...
jQuery(document).ready(function ($) {
  ...
  if (
    ...
    window.location.href ==
      "https://easyjet.collinsoninsurance.com/pt-PT/support/tickets/new" ||
    window.location.href ==
  ...
  //ENGLISH
    ...
    window.location.href ==
      "https://www.easyjetclaims.com/support/tickets/new" ||
    window.location.hostname == "www.easyjetclaims.com"
  ) {
  ...
  if (
    ...
    window.location.href ==
      "https://www.easyjetclaims.com/support/tickets/new" ||
    window.location.href == "https://www.easyjetclaims.com/support/tickets/"
  ) {
    $("button.new-ticket-submit-button")
      .hide()
      .after(
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    if (
      ...
      window.location.href ==
        "https://www.easyjetclaims.com/support/tickets/new" ||
      window.location.hostname == "https://www.easyjetclaims.com"
    ) {
      // English
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Submit</button>'
    ...
    if ($("#title").hasClass("EasyJet")) {
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            console.log("+++++++++>", policyNumber,policyEmail)
      ...
      if (
        ...
        if (
          ...
          console.log("error display for birthday -------->");
          if ($("#title").hasClass("ColumbusItaly")) {
            addErrorMessage(
              "helpdesk_ticket_custom_field_cf_policy_number_post_office_2321673",
              "Si prega di compilare tutti i campi"
          ...
          if (
            ...
            console.log("-- inside -->", $("#helpdesk_ticket_custom_field_cf_policy_number_post_office_2321673").val());
            birthdate = $(
              "#helpdesk_ticket_custom_field_cf_date_of_birth_2321673"
            ).val();
