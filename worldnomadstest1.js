...
jQuery(document).ready(function ($) {
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    //check for portal
    if ($("#title").hasClass("VHI") || $("#title").hasClass("ColumbusItaly") || $("#title").hasClass("NIB")) {
      // $('.form-select').hide()
    ...
    if ($("#title").hasClass("ColumbusItaly")) {
      ...
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Find Policy</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673"); //$("#title").hasClass("NIB")
    }else if ($("#title").hasClass("NIB")) {
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Find Policy</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mainclientid_2321673"); //$("#title").hasClass("NIB")
    }
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    } else if ($("#title").hasClass("VHI") || $("#title").hasClass("NIB") ) {
      $(
  ...
  $(document).on("click","#save_and_continue1",function() {
    ...
    if ($("#title").hasClass("EasyJet")) {
      ...
      $("#title").hasClass("VHI") ||
      $("#title").hasClass("ColumbusItaly")|| $("#title").hasClass("NIB")
    ) {
      if (
        document.getElementById("cpatchaTextBox").value == code ||
        jQuery(".fw-comments-wrapper").length
      ...
      if (
        ...
        if (
          ...
          //check LENGTH OF POLICY NUMBER - 6 DIGITS
          console.log("-----testing----> inside else")
          if (
            $(
              "#helpdesk_ticket_custom_field_cf_policy_number_post_office_2321673"
            ).val().length >= 6
