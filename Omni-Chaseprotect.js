...
jQuery(document).ready(function ($) {
  ...
  var italy_titles = [
    ...
    "Che cosa ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨ accaduto",
    "I tuoi documenti",
    ...
    fetch("https://" + domainURL + "/authenticate", requestOptions)
      ...
      .then(function (result) {
        ...
        if (fieldId) {
          ...
          if (tokenIndex !== -1) {
            jQuery("#collapseSection1").addClass("d-none");
            ...
            setTimeout(function () {
              ...
              jQuery("#collapseSection1").removeClass("d-none");
            }, 500);
  ...
  function getTokenPolicyDetails(bodyobject) {
    ...
    fetch("https://claim-proxy.collinsonnis.com/api/policy", requestOptions)
      .then((response) => {
        statusCode = response.status;
        if (!response.ok) {
  ...
  function buildPolicyUI(policyData) {
    ...
    if ($("#title").hasClass("ColumbusItaly")) {
      ...
      options +=
        '<div ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ class="form-group"><label id="insured-bold" class="form-label" style="display:inline-table;font-weight: 900;" > Name(s) of the Insured. Please TICK everyone who was involved in the claim! </label><br><label id="selectAClaiment">Please select a claimant</label>';
    }
  ...
  var ClaimReason = [
    {
      ...
      name_ita:
        "Sinistri relativi a Covid 19 ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“ Cancellazione",
    },
    {
    ...
    },
    {
      ...
      name_ita:
        "Ritardo del bagaglio allÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢arrivo a destinanzione",
    },
    {
      id: "01_03_CxIllClnt",
    ...
    },
    {
      id: "01_02_Curt",
      name_eng:
        "Curtailment ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“ returned home early",
  ...
  var Destination = [
    ...
    },
    {
      id: "PE",
      name_eng: "Peru",
      lang_ita: "PerÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¹",
    },
    {
      id: "PH",
  ...
  var CurrencyType = [
    ...
    {
      id: "CRC",
      name_eng: "Costa Rican ColÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n",
      lang_ita: "ColÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n costaricano",
    },
    {
      id: "HRK",
    ...
    {
      id: "ISK",
      name_eng: "Icelandic KrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³na",
    ...
    },
    {
      id: "MNT",
      name_eng:
        "Mongolian tÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶grÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶g",
      lang_ita:
        "TÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶grÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶g Mongolo",
    },
    {
      id: "MAD",
  ...
  var LossTheftWhere = [
    {
      ...
      name_ita:
        "Dal tuo veicolo di proprietÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  o in affitto",
    },
    {
  ...
  var SkiPackClaimReason = [
    ...
    },
    {
      ...
      name_ita:
        "PiÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¹ di un oggetto elencato",
    },
  ];
  /* 5.9 End */
  ...
  $("#save_and_continue3").click(function () {
    ...
    if (checkedfilled(list_to_check2) == true) {
      ...
      if (
        ...
        $("#save_and_continue3").attr({
          "data-bs-toggle": "modal",
          "data-bs-target": "ClaimAPIModal",
        });
        let claimObject = {};
        let destiny = getAKey(
          "helpdesk_ticket_custom_field_cf_your_destination_2321673",
    ...
    fetch("https://" + domainURL + "/api/claim", requestOptions)
      ...
      .then(function (result) {
        ...
        if (flag) {
          ...
          if ($("#title").hasClass("ColumbusItaly")) {
            $(".claim-number").append(
              `Il tuo numero di reclamo ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨ ${ClaimInitiatedNumber}`,
            );
          } else {
            $(".claim-number").append(
  ...
  var reasonForClaimObj = {
    "Any CANCELLATION claim due to COVID-19": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  di disdetta come la conferma della prenotazione per eventuale test Coronavirus e evidenza di esito positivo. ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¹ÃƒÂ¢Ã¢â€šÂ¬  sufficiente solo la conferma tramite e-mail, non accettiamo la conferma tramite SMS.<br>",
    ...
    "Baggage - personal items lost or stolen": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Denuncia alle autoritÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  locali che confermi gli eventi da cui ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨ scaturito il sinistro.<br>Scontrino/ricevuta d'acquisto per il bene alla base del sinistro.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Baggage - suitcase hasn't arrived on time": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Il rapporto di irregolaritÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  bagaglio rilasciato dal vettore.<br>Scontrino/ricevuta d'acquisto per il bene di prima necessitÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ .<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Cancelled trip - (NOT related to COVID-19)": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  di disdetta Documentazione che indichi la necessitÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  di cancellare il viaggio es. Documentazione medica.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Curtailment ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“ returned home early":
      {
        ...
        italian_paragraph:
          "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Qualsiasi altro documento che sia rilevante per il tuo sinistro.<br>",
        titles: ["Booking Invoice", "Other Docs"],
        images: [
          "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
          "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
