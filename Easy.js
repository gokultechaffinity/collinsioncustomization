...
jQuery(document).ready(function ($) {
  ...
  if (
    ...
    "https://easyjet.collinsoninsurance.com/it/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
    ...
    window.location.href ==
    "https://easyjet.collinsoninsurance.com/de/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
    ...
    window.location.href ==
    "https://easyjet.collinsoninsurance.com/pt-PT/support/tickets/new" ||     window.location.href ==
    "https://easyjet.collinsoninsurance.com/pt-BR/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
    ...
    window.location.href ==
    "https://easyjet.collinsoninsurance.com/es/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
  ...
  //FRENCH
    ...
    window.location.href ==
    "https://easyjet.collinsoninsurance.com/fr/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Saisir le Captcha</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
  ...
  //ENGLISH
    ...
    window.location.href ==
    "https://easyjet.collinsoninsurance.com/en/support/tickets/new"
  ) {
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
    ...
    window.location.href ==
    "https://www.easyjetclaims.com/support/tickets/new" || window.location.hostname ==
    "www.easyjetclaims.com"
  ) {
  ...
  if (
    ...
    window.location.href ==
    "https://www.easyjetclaims.com/support/tickets/new" || window.location.href ==
    "https://www.easyjetclaims.com/support/tickets/"
  ) {
    $("button.new-ticket-submit-button")
      .hide()
      .after(
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    if (window.location.href == "https://easyjet.collinsoninsurance.com/it/support/tickets/new" ) 
    {// Italian
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Trova la polizza</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (window.location.href =="https://easyjet.collinsoninsurance.com/de/support/tickets/new") {
      // German
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Finde die Police</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (window.location.href =="https://easyjet.collinsoninsurance.com/es/support/tickets/new") {
      // Spanish
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encuentra la pÃƒÂ³liza</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (window.location.href =="https://easyjet.collinsoninsurance.com/pt-PT/support/tickets/new" ||     window.location.href ==
    "https://easyjet.collinsoninsurance.com/pt-BR/support/tickets/new") {
      // Portuguese
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encontrar a apÃƒÂ³lice</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (window.location.href =="https://easyjet.collinsoninsurance.com/fr/support/tickets/new") {
      // French
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Trouvez la police</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (window.location.href =="https://easyjet.collinsoninsurance.com/en/support/tickets/new") {
      // English
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Submit</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    }
    else if (window.location.href =="https://www.easyjetclaims.com/support/tickets/new" || window.location.hostname == "https://www.easyjetclaims.com"
    ) {
      // English
      $('<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Submit</button>').insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    }
    ...
    if (
      ...
      window.location.href ==
      "https://www.easyjetclaims.com/support/tickets/new" || window.location.hostname == "https://www.easyjetclaims.com"
    ) {
      // English
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >Continue</button>'
    ...
    if (
      ...
      window.location.href == "https://www.easyjetclaims.com/support/tickets/new" || window.location.hostname == "https://www.easyjetclaims.com"
    ) {
      // English
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">Continue</button>'
  ...
  function buildPolicyUI(policyData) {
    ...
    if ($("#title").hasClass("ColumbusItaly")) {
      ...
      options +=
        '<div class="form-group"><label id="insured-bold" class="form-label" style="display:inline-table;font-weight: 900;" > Name(s) of the Insured. Please TICK everyone who was involved in the claim! </label><br><label id="selectAClaiment">Merci de remplir tous les champs</label>';
    }
