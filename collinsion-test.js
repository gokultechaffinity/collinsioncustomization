    ...
    if (checkedfilled(list_to_check2) == true) {
      ...
      if (
        ...
        if ($("#section_3_header").length) {
          console.log("-----update section-->",$("#section_3_header").length);
          update_section_3();
        } else {
    ...
    if (elem.files.length) {
      ...
      if (sum <= 5242880) {
        ...
        if ($("#section_5_header").length) {
          console.log("----------update_section_5------------>",$("#section_5_header").length);
          update_section_5();
        } else {
          console.log("----------add_section_5------------>",$("#section_5_header").length);
          add_section_5();
        }
...
;
  ...
  $(".save_and_continue5").click(function () {
    console.log(".save_and_continue5 click ---->",$("#section_4_header").length);
    if ($("#section_4_header").length) {
      console.log("update section ----> 4");
      update_section_4();
      add_section_5();
    ...
    if (jQuery(".fw-comments-wrapper").length > 0) {
      console.log(" existing ticket flow ---->");
      update_section_4_continue();
      open_next(5);
      ...
      console.log(" existing ticket flow section header ---->",$("#section_5_header").length);
      if($("#section_5_header").length){
        update_section_5();
      }else{
        add_section_5();
