...
jQuery(document).ready(function ($) {
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      ...
      $(".fw-helpdesk-ticket-forms-dropdown-container").hide();  
    ...
    } else if (window.location.href === "https://worldnomads.collinsoninsurance.com/support/tickets/new?ticket_form=worldnomadseu"){ 
