jQuery(document).ready(function ($) {
  ...
  function getJWTToken() {
    ...
    fetch(
      "https://claim-sandbox.collinsonnis.com/collinson-app/authenticate?qyjo=techaffinity&ovgb=cTkdpBQe02QvMkwZ0jCB",
      requestOptions
    )
  ...
  /* 5.1 Start */
  var LossOrTheft = [
    { id: "Loss", name_eng: "Loss", name_ita: "Perdita" },
    { id: "Theft", name_eng: "Theft", name_ita: "Furto" },
  ];
  var LossTheftWhere = [
    {
      id: "InVehicle",
    ...
    { id: "Other", name_eng: "Other", name_ita: "Altro" },
    { id: "HotelRoom", name_eng: "Hotel room", name_ita: "Camera d'albergo" },
    {
      id: "SafetyDepositBox",
  ...
  var LossTheftVehicle = [
    { id: "BackSeat", name_eng: "Back Seat", name_ita: "Sedile posteriore" },
    { id: "FootWell", name_eng: "Foot Well", name_ita: "Poggiapiedi" },
    {
      id: "GloveBox",
      name_eng: "Glove Box",
      name_ita: "Cruscotto / Vano portaoggetti",
    },
    { id: "FrontSeat", name_eng: "Front Seat", name_ita: "Posto di fronte" },
    { id: "Boot", name_eng: "Boot", name_ita: "Portabagagli" },
  ];
  var LossTheftReportedTo = [
    ...
    { id: "Police", name_eng: "Police", name_ita: "Polizia" },
    {
      id: "TourOperator",
  ...
  var NoReportReason = [
    ...
    { id: "Other", name_eng: "Other reason", name_ita: "Altro" },
  ];
  var ItemType = [
    { id: "Gadgets", name_eng: "Gadgets", name_ita: "Apaprecchi garantiti" },
    { id: "Jewellery", name_eng: "Jewellery", name_ita: "Gioielleria" },
    { id: "Electronics", name_eng: "Electronics", name_ita: "Elettronica" },
    { id: "MobilePhone", name_eng: "Mobile Phone", name_ita: "Cellulare" },
    {
      id: "PersonalPossessions",
      name_eng: "Personal Possessions",
      name_ita: "Effetti Personali",
    },
    { id: "Cosmetics", name_eng: "Cosmetics", name_ita: "Cosmetici" },
    {
  ...
  var ItemOwner = [
    { id: "Myself", name_eng: "Myself", name_ita: "Io" },
    {
      id: "InsuredAdult",
      name_eng: "An Insured Adult",
      name_ita: "Adulto assicurato",
    },
    { id: "Hired", name_eng: "Hired Item", name_ita: "Affittato" },
    {
      id: "BorrowedOrLoaned",
  ...
  var ReasonForCancellation = [
    ...
    { id: "Pregnancy", name_eng: "Pregnancy", name_ita: "Gravidanza" },
    {
  ...
  var WhoAdvisedToCancel = [
    { id: "GeneralPractitioner", name_eng: "Doctor", name_ita: "Dottore" },
    { id: "Hospital", name_eng: "Hospital", name_ita: "Ospedale" },
    { id: "Other", name_eng: "Other", name_ita: "Altro" },
    { id: "None", name_eng: "No treatment", name_ita: "Nessun Trattamento" },
  ];
  ...
  var MissedDepartureReason = [
    ...
    { id: "Other", name_eng: "Other", name_ita: "Other" },
    {
      id: "DeniedBoarding",
  ...
  var MissedDepDelayReason = [
    ...
    { id: "Strike", name_eng: "Strike", name_ita: "Strike" },
    {
      id: "IndustrialAction",
  ...
  var MissedDepExpenseType = [
    ...
    { id: "Travel", name_eng: "Travel", name_ita: "Travel" },
  ];
  /* 5.5 End */

  /* 5.6 Start */
  var WhoMedicalExpenses = [
    { id: "Insured", name_eng: "Myself", name_ita: "Me stessa" },
    {
      id: "AnotherInsured",
  ...
  var MedicalInjuryIllness = [
    { id: "Illness", name_eng: "Illness", name_ita: "Malattia" },
    { id: "Injury", name_eng: "Injury", name_ita: "Infortunio" },
    {
      id: "Coronavirus",
  ...
  var MedicalFirstExpenseType = [
    ...
    { id: "CovidTest", name_eng: "Covid Test", name_ita: "Prova Covid" },
    {
      id: "Physiotherapy",
  ...
  /* 5.8 Start */
  var SubAccomReason = [
    { id: "Fire", name_eng: "Fire", name_ita: "Fire" },
    { id: "Flood", name_eng: "Flood", name_ita: "Flood" },
    { id: "Storm", name_eng: "Storm", name_ita: "Storm" },
    {
      id: "NaturalCastrophe",
  ...
  var TransportationMethod = [
    { id: "Areoplane", name_eng: "Aeroplane", name_ita: "Areoplano" },
    { id: "Ferry", name_eng: "Ferry", name_ita: "Traghetto" },
    { id: "Coach", name_eng: "Coach", name_ita: "Autobus" },
    { id: "Train", name_eng: "Train", name_ita: "Treno" },
    { id: "Cruise", name_eng: "Cruise", name_ita: "Crociera" },
  ];
  var ReasonForDelay = [
    { id: "Other", name_eng: "Other", name_ita: "Altro" },
    {
    ...
    { id: "Strike", name_eng: "Strike", name_ita: "Sciopero" },
    {
      id: "IndustrialAction",
      name_eng: "Industrial Action",
  ...
  var WhichJourneyNew = [
    ...
    {
      id: "Inbound",
      name_eng: "Final inbound journey to your Home Country",
      name_ita: "Ultima tratta di ritorno al Suo paese di residenza",
    },
    {
      id: "Outbound",
      name_eng: "First outbound journey from your Home Country",
      name_ita:
  ...
  var TransportationMethodDelayed = [
    { id: "Aeroplane", name_eng: "Aeroplane", name_ita: "Aeroplane" },
    { id: "Ferry", name_eng: "Ferry", name_ita: "Traghetto" },
    { id: "Coach", name_eng: "Coach", name_ita: "Autobus" },
    { id: "Train", name_eng: "Train", name_ita: "Treno" },
    { id: "Other", name_eng: "Other", name_ita: "Altro" },
  ...
  $("#save_and_continue6").click(function () {
    ...
    if (checkedfilled(payment_list) == true) {
      ...
      //sortCode
      //countryCode
      ValidateBankMethodOne(iBanNumber, countryCode[0].akey);
      ValidateBankMethodTwo(accountNumber, sortCode, countryCode[0].akey);
