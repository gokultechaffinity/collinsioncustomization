jQuery(document).ready(function ($) {
  ...
  $(".new-ticket-dummy").click(function () {
    ...
    console.log(JSON.parse(bankResult).bankName);
    if (bankResult) {
