...
jQuery(document).ready(function ($) {
  ...
  var german_titles = [
    ...
    "ÃƒÅ“ber Sie",
    "ÃƒÅ“ber Ihre Reise",
    "Bitte erzÃƒÂ¤hlen Sie uns was passiert ist",
    "Ihre Dokumente",
    "Ihre Zahlungsdetails",
    "Ihre AnspruchsÃƒÂ¼bersicht",
  ];
  var french_titles = [
    "Votre police",
    "Vos informations",
    "ÃƒÆ’ propos de votre voyage",
    "Dites-nous ce qui s'est passÃƒÂ©",
    "Vos documents",
    "Vos dÃƒÂ©tails de paiement",
    "RÃƒÂ©sumÃƒÂ© de votre rÃƒÂ©clamation",
  ];
  var portuguese_titles = [
    ...
    "Resumo da sua reclamaÃƒÂ§ÃƒÂ£o",
  ];
  var spanish_titles = [
    "Tu Poliza",
    "InformaciÃƒÂ³n sobre usted",
    "Acerca de tu viaje",
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Appel API ÃƒÆ’Ã‚Â©chouÃƒÆ’Ã‚Â©</div>',
      );
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Appel API ÃƒÆ’Ã‚Â©chouÃƒÆ’Ã‚Â©</div>',
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Appel API ÃƒÆ’Ã‚Â©chouÃƒÆ’Ã‚Â©</div>',
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Appel API ÃƒÆ’Ã‚Â©chouÃƒÆ’Ã‚Â©</div>',
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Appel API ÃƒÆ’Ã‚Â©chouÃƒÆ’Ã‚Â©</div>',
      );
  } else if (currentUrl.includes("/en/")) {
    // English
    $(
  ...
  if ($("#new_helpdesk_ticket").length || $(".edit_helpdesk_ticket").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // Spanish
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encontrar pÃƒÂ³liza</button>',
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Localizar apÃƒÂ³lice</button>',
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  if (jQuery(".fw-comments-wrapper").length > 0) {
    ...
    if (
      ...
      // Portuguese
      $(
        '<button class="save_and_continue5 btn btn-primary for-section-5 save_and_continue" type="button" >PrÃƒÂ³xima sesiÃƒÂ³n</button>',
      ).insertAfter(".attachments.for-section-5");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // Portuguese
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >PrÃƒÂ³xima sesiÃƒÂ³n</button>',
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  function thisDiv(number, title) {
    ...
    $(
      '<div id="overall_div_' +
        ...
        '<div id="section-' +
        number +
        '-button" class="ins-col-test collapsed col align-self-end" ' +
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend("<p>TUTTI i documenti caricati non devono superare i 5MB!</p>");
  } else if (currentUrl.includes("/en/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend("<p>ALL documents being uploaded must not exceed 5MB!</p>");
  } else if (currentUrl.includes("/de/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend(
        "<p>ALLE hochgeladenen Dokumente dÃƒÂ¼rfen 5MB nicht ÃƒÂ¼berschreiten!</p>",
      );
  } else if (currentUrl.includes("/fr/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend(
        "<p>TOUS les documents tÃƒÂ©lÃƒÂ©chargÃƒÂ©s ne doivent pas dÃƒÂ©passer 5MB!</p>",
      );
  } else if (currentUrl.includes("/es/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend(
        "<p>Ã‚Â¡TODOS los documentos que se suban no deben exceder los 5MB!</p>",
      );
  } else if (currentUrl.includes("/pt-PT/")) {
    ...
    $("#collapseSection5")
      .children(".card-body")
      .prepend("<p>TODOS os documentos enviados nÃƒÂ£o devem exceder 5MB!");
  }
  ...
  if ($(".edit_helpdesk_ticket").length > 0) {
    ...
    $(
      "#section-2-button, #section-3-button, #section-4-button, #section-5-button, #section-6-button",
    ...
    $("#" + element_ID).focusout(function () {
      ...
      if (today < test_date) {
        if (currentUrl.includes("/it/")) {
          addErrorMessage(
            element_ID,
            "La data deve essere passata o presente.",
          );
        } else if (currentUrl.includes("/es/")) {
          addErrorMessage(
            element_ID,
            "La fecha debe estar en pasado o presente.",
          );
        } else if (currentUrl.includes("/fr/")) {
          addErrorMessage(
            element_ID,
            "La date doit ÃƒÂªtre dans le passÃƒÂ© ou le prÃƒÂ©sent.",
          );
        } else if (currentUrl.includes("/de/")) {
          addErrorMessage(
            element_ID,
            "Das Datum muss in der Vergangenheit oder Gegenwart liegen.",
          );
        } else if (currentUrl.includes("/pt-PT/")) {
  ...
  function summary_section_start() {
    ...
    if ($("#summary_intro").length) {
      ...
      if (currentUrl.includes("/it/")) {
        ...
        $(
          '<p id="summary_intro">Bitte nehmen Sie sich einen Moment Zeit, um Ihre Informationen zu ÃƒÂ¼berprÃƒÂ¼fen - Genauigkeit hilft uns dabei, Ihren Anspruch schnell zu bearbeiten.</p>',
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");
      } else if (currentUrl.includes("/es/")) {
        $(
          '<p id="summary_intro">Por favor, tÃƒÂ³mese un momento para revisar su informaciÃƒÂ³n: la precisiÃƒÂ³n nos ayuda a procesar su reclamaciÃƒÂ³n rÃƒÂ¡pidamente.</p>',
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");
      } else if (currentUrl.includes("/fr/")) {
        $(
          '<p id="summary_intro">Veuillez prendre un moment pour vÃƒÂ©rifier vos informations : leur exactitude nous aide Ãƒ  traiter votre demande rapidement.</p>',
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");
      } else if (currentUrl.includes("/pt-PT/")) {
        $(
          '<p id="summary_intro">Reserve um momento para verificar suas informaÃƒÂ§ÃƒÂµes. A precisÃƒÂ£o nos ajuda a processar sua reclamaÃƒÂ§ÃƒÂ£o rapidamente.</p>',
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");
      } else if (currentUrl.includes("/pt-BR/")) {
        $(
          '<p id="summary_intro">Reserve um momento para verificar suas informaÃƒÂ§ÃƒÂµes. A precisÃƒÂ£o nos ajuda a processar sua reclamaÃƒÂ§ÃƒÂ£o rapidamente.</p>',
  ...
  function openAgreementModal() {
    var agreementModal = new bootstrap.Modal(
  ...
  $("#save_and_continue1").click(function () {
    if (
      $("#title").hasClass("EasyJet") ||
      $("#portalClass").hasClass("EasyJetEU")
    ) {
      //checkRecaptcha
      if (
        ...
        if (
          ...
          if (currentUrl.includes("/it/")) {
            ...
            addErrorMessage(
              "helpdesk_ticket_custom_field_cf_policy_number_post_office_2321673",
              "Bitte fÃƒÂ¼llen Sie alle Felder aus",
            );
            addErrorMessage(
              "helpdesk_ticket_custom_field_cf_policy_email_2321673",
              "Bitte fÃƒÂ¼llen Sie alle Felder aus",
        ...
        if (currentUrl.includes("/it/")) {
          ...
          addErrorMessage(
            "captcha_failed",
            "UngÃƒÂ¼ltiges Captcha. Bitte geben Sie das Captcha erneut ein.",
          );
          createCaptcha();
        } else if (currentUrl.includes("/es/")) {
          addErrorMessage(
            "captcha_failed",
            "Captcha invÃƒÂ¡lido. Por favor vuelve a ingresar el captcha",
          );
          createCaptcha();
        } else if (currentUrl.includes("/pt-PT/")) {
          addErrorMessage(
            "captcha_failed",
            "Captcha invÃƒÂ¡lido. Por favor digite novamente o captcha",
          );
          createCaptcha();
        } else if (currentUrl.includes("/pt-BR/")) {
          addErrorMessage(
          ...
          addErrorMessage(
            "captcha_failed",
            "Captcha invalide. Veuillez saisir Ãƒ  nouveau le captcha",
          );
          createCaptcha();
        } else {
          addErrorMessage(
        ...
        if (flag) {
          ...
          if (statusCode == 401) {
            ...
            if (currentUrl.includes("/it/")) {
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Advertencia Algo no estÃƒÂ¡ del todo bien. Por favor, intÃƒÂ©ntalo de nuevo y si el problema persiste, ponte en contacto con el equipo utilizando el botÃƒÂ³n 'ContÃƒÂ¡ctanos' en el pie de pÃƒÂ¡gina.",
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Advertencia Algo no estÃƒÂ¡ del todo bien. Por favor, intÃƒÂ©ntalo de nuevo y si el problema persiste, ponte en contacto con el equipo utilizando el botÃƒÂ³n 'ContÃƒÂ¡ctanos' en el pie de pÃƒÂ¡gina.",
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Avertissement.  quelque chose ne va pas. Veuillez rÃƒÂ©essayer et si le problÃƒÂ¨me persiste, veuillez contacter l'ÃƒÂ©quipe en utilisant le bouton Ã‚Â«Ã‚ Contactez-nousÃ‚ Ã‚Â» en pied de page.",
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Avertissement.  quelque chose ne va pas. Veuillez rÃƒÂ©essayer et si le problÃƒÂ¨me persiste, veuillez contacter l'ÃƒÂ©quipe en utilisant le bouton Ã‚Â«Ã‚ Contactez-nousÃ‚ Ã‚Â» en pied de page.",
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Erro de polÃƒÂ­tica Estamos tendo problemas para encontrar sua apÃƒÂ³lice. Verifique as informaÃƒÂ§ÃƒÂµes inseridas em relaÃƒÂ§ÃƒÂ£o ao cronograma da sua apÃƒÂ³lice. Ainda tendo problemas? VocÃƒÂª pode entrar em contato conosco aqui.",
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Erro de polÃƒÂ­tica Estamos tendo problemas para encontrar sua apÃƒÂ³lice. Verifique as informaÃƒÂ§ÃƒÂµes inseridas em relaÃƒÂ§ÃƒÂ£o ao cronograma da sua apÃƒÂ³lice. Ainda tendo problemas? VocÃƒÂª pode entrar em contato conosco aqui.",
  ...
  function buildPolicyUI(policyData) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      options +=
        "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Bitte wÃƒÂ¤hlen Sie einen Antragsteller aus</label>";
    } else if (currentUrl.includes("/es/")) {
      options +=
      ...
      options +=
        "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Veuillez sÃƒÂ©lectionner un demandeur</label>";
    } else if (currentUrl.includes("/pt-PT/")) {
      options +=
  ...
  $("#save_and_continue2").click(function () {
    ...
    if (len <= 0) {
      ...
      if (currentUrl.includes("/it/")) {
        ...
        addErrorMessage(
          "check-finder",
          "Bitte wÃƒÂ¤hlen Sie mindestens einen Versicherten aus",
        );
      } else if (currentUrl.includes("/fr/")) {
        addErrorMessage(
          "check-finder",
          "Veuillez sÃƒÂ©lectionner au moins un client",
        );
      } else if (currentUrl.includes("/pt-PT/")) {
  ...
  var ClaimReason = [
    {
      ...
      name_ita:
        "Sinistri relativi a Covid 19 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Cancellazione",
    },
    {
  ...
  var CurrencyType = [
    {
      ...
      lang_spa: "DÃƒÂ³lar Estadounidense",
    },
    {
      id: "EUR",
      name_eng: "Euro",
    ...
    },
    {
      ...
      lang_spa: "DÃƒÂ³lar Australiano",
    },
    {
      id: "CAD",
      name_eng: "Canadian Dollar",
      lang_ita: "Dollaro Canadese",
      lang_spa: "DÃƒÂ³lar Canadiense",
    },
    {
      id: "AFN",
    ...
    },
    {
      ...
      lang_spa: "Dirham de los Emiratos ÃƒÂrabes",
    },
    {
      id: "ARS",
    ...
    },
    {
      ...
      lang_spa: "DÃƒÂ³lar de Belice",
    },
    {
      id: "BMD",
      name_eng: "Bermudan Dollar",
      lang_ita: "Dollaro Bermudiano",
      lang_spa: "DÃƒÂ³lar BermudeÃƒÂ±o",
    },
    {
      id: "BOB",
    ...
    },
    {
      ...
      lang_spa: "Franco CFA de ÃƒÂfrica Central",
    },
    {
      id: "XOF",
      name_eng: "Central African CFA franc",
    ...
    },
    {
      ...
      lang_spa: "DÃƒÂ³lar del Caribe Oriental",
    },
    {
      id: "EGP",
    ...
    },
    {
      ...
      lang_spa: "Birr EtÃƒÂ­ope",
    },
    {
      id: "FJD",
      name_eng: "Fijian Dollar",
      lang_ita: "Dollaro Fijiano",
      lang_spa: "DÃƒÂ³lar Fiyiano",
    },
    {
      id: "GMD",
    ...
    },
    {
      ...
      lang_spa: "ChelÃƒÂ­n Keniano",
    },
    {
      id: "KWD",
      name_eng: "Kuwaiti Dinar",
      lang_ita: "Dinaro Kuwaitiano",
      lang_spa: "Dinar KuwaitÃƒÂ­",
    },
    {
      id: "LBP",
    ...
    },
    {
      ...
      lang_spa: "Nuevo DÃƒÂ³lar TaiwÃƒÂ¡n",
    },
    {
      id: "NZD",
      name_eng: "New Zealand Dollar",
      lang_ita: "Dollaro Neozelandese",
      lang_spa: "DÃƒÂ³lar NeozelandÃƒÂ©s",
    },
    {
      id: "NGN",
    ...
    },
    {
      ...
      lang_spa: "BolÃƒÂ­var Venezolano",
    },
    {
      id: "VND",
  ...
  function getAKey(id, array) {
    ...
    array.forEach(function (item) {
      if (
        item.name_eng == getval ||
        item.name_ita == getval ||
        item.name_spa == getval
      ) {
        obj["akey"] = item.id;
      }
    });
  ...
  var reasonForClaimObj = {
    "Any CANCELLATION claim due to COVID-19": {
      ...
      german_paragraph:
        "Wir benÃƒÂ¶tigen diese wichtigen Dokumente, um ÃƒÂ¼ber Ihren Anspruch entscheiden zu kÃƒÂ¶nnen:<br>Die Buchungsrechnung Ihrer Reise mit Angabe der Kosten, Ihres Namens sowie des Abreise- und RÃƒÂ¼ckreisedatums.<br>Stornorechnung von jedem Unternehmen, bei dem Sie gebucht haben, mit Nachweis der StornogebÃƒÂ¼hr.<br>Dokumente, die die Notwendigkeit der Stornierung belegen, z. B. ein ÃƒÂ¤rztliches Schreiben oder ein VerspÃƒÂ¤tungsbericht.<br>ALLE hochgeladenen Dokumente dÃƒÂ¼rfen nicht grÃƒÂ¶ÃƒÅ¸er als 5 MB sein!",
  ...
  //           "<p style='color:red;' >ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃƒÂ­nelo e intente nuevamente.</p><br><p style='color:red;'>ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃƒÂ­nelo e intente nuevamente.</p>"
  //         );
  //         } if(currentUrl.includes('/it/') ){
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  ...
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  //             "<p style='color:red;' >WARNUNG - Nicht unterstÃƒÂ¼tztes Dateiformat angehÃƒÂ¤ngt. Bitte entfernen Sie die Datei und versuchen Sie es erneut.</p><br><p style='color:red;'>Wir unterstÃƒÂ¼tzen die folgenden Dateiformate: jpeg, jpg, png, bmp, pdf, doc, docx, xls und xlsx.</p>"
  //           );
  //         }else if(currentUrl.includes('/fr/') ){
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  //             "<p style='color:red;' >AVERTISSEMENT - Format de fichier joint non pris en charge. Veuillez supprimer et rÃƒÂ©essayer</p><br><p style='color:red;'>Nous prenons en charge les formats de fichiers suivants : jpeg, jpg, pnh, bmp, pdf,doc, docx, xls et xlsx.</p>"
  //           );
  //         } else if(currentUrl.includes('/pt-PT/') ){
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  //             "<p style='color:red;' >AVISO - Formato de arquivo nÃƒÂ£o suportado anexado. Remova e tente novamente</p><br><p style='color:red;'>Suportamos os seguintes formatos de arquivo - jpeg, jpg, pnh, bmp, pdf,doc, docx, xls e xlsx.</p>"
  //           );
  //         } else if(currentUrl.includes('/pt-BR/') ){
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  ...
  //           addErrorMessage(
  //             "api_call_failed_filelist",
  //             "<p style='color:red;' >ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃƒÂ­nelo e intente nuevamente.</p><br><p style='color:red;'>Soportamos los siguientes formatos de archivo: jpeg, jpg, png, bmp, pdf, doc, docx, xls y xlsx.</p>"
  //           );
  //         } else {
  ...
  $(".save_draft_5").click(function () {
    ...
    if (elem.files.length) {
      ...
      // NEW: Individual file size validation flag
      let individualFileSizeExceeded = false;

      for (let i of elem) {
        // NEW: Check individual file size (5 MB)
        if (elem.files[i].size > 5242880) {
          individualFileSizeExceeded = true;
        }
      ...
      // NEW: Combined size limit changed to 10 MB
      if (!individualFileSizeExceeded && sum <= 10485760) {
        let ele = ["api_call_failed_filelist"];
        clearError(ele);
        ...
        if (!FileExtensionValidateCounter && !formatValidateCounter) {
          ...
          if ($("#title").hasClass("ColumbusItaly")) {
            addErrorMessage(
              "api_call_failed_filelist",
              "Formato file non supportato. Formati supportati: test(.gif),jpeg,jpg,png,bmp,tiff,tif,pdf,doc,docx,xls,xlsx,txt,odt,msg,eml",
            );
          } else {
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >WARNING - Unsupported File Format attached. Please remove and try again</p><br><p style='color:red;'>We support the following file formats - jpeg, jpg, png, bmp, pdf, doc, docx, xls, xlsx, txt, odt, msg and eml.</p>",
            );
          }
        }
      } else {
        console.log(
          "--------- Need to show error file size validation ---------",
        );

        if (individualFileSizeExceeded) {
          addErrorMessage(
            "api_call_failed_filelist",
            "Each file size cannot exceed 5 MB",
          );
        } else {
          addErrorMessage(
            "api_call_failed_filelist",
            "Total file size of all attachments cannot exceed 10 MB",
          );
        }
      }
    } else {
  ...
  function fileUploadCallback() {
    ...
    if (elem.files.length) {
      ...
      // NEW: Combined file size should not exceed 10 MB
      if (!individualFileSizeExceeded && sum <= 10485760) {
        let ele = ["api_call_failed_filelist"];
        clearError(ele);
        ...
        if (flag) {
          ...
          if (statusCode == 500) {
            ...
            if (currentUrl.includes("/it/")) {
              ...
              addErrorMessage(
                "api_call_failed_banvalidate",
                "Wir kÃƒÂ¶nnen die angegebenen Bankkontoinformationen nicht bestÃƒÂ¤tigen. Bitte ÃƒÂ¼berprÃƒÂ¼fen Sie alle Details und geben Sie diese nochmals ein. ",
              );
            } else if (currentUrl.includes("/pt-PT/")) {
              addErrorMessage(
                "api_call_failed_banvalidate",
                "NÃƒÂ£o podemos processar as informaÃƒÂ§ÃƒÂµes da conta bancÃƒÂ¡ria fornecidas. Por favor, verifique todos os detalhes e reenvie.",
              );
            } else if (currentUrl.includes("/pt-PT/")) {
              addErrorMessage(
                "api_call_failed_banvalidate",
              ...
              addErrorMessage(
                "api_call_failed_banvalidate",
                "No podemos procesar la informaciÃƒÂ³n de la cuenta bancaria proporcionada. Por favor, verifica todos los detalles y envÃƒÂ­alos nuevamente.",
              );
            } else {
              addErrorMessage(
                "api_call_failed_banvalidate",
        ...
        $(
          ...
          if (new_today < replacement_purchase_date) {
            ...
            if (currentUrl.includes("/it/")) {
              ...
              addErrorMessage(
                "helpdesk_ticket_custom_field_cf_on_what_date_did_you_purchase_the_replacement_items_2321673",
                "La date doit ÃƒÂªtre dans le passÃƒÂ©",
              );
            } else if (currentUrl.includes("/de/")) {
              addErrorMessage(
                "helpdesk_ticket_custom_field_cf_on_what_date_did_you_purchase_the_replacement_items_2321673",
  ...
  $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").change(
    function () {
      if (
        ...
        $(
          "label[for='helpdesk_ticket_custom_field_cf_when_did_the_symptoms_start_2321673'],#helpdesk_ticket_custom_field_cf_when_did_the_symptoms_start_2321673, .form-group.helpdesk_ticket_custom_field_cf_what_medical_condition_has_resulted_in_cancellation748907_2321673",
        ).hide();
        $(
        ...
        $(
          "label[for='helpdesk_ticket_custom_field_cf_on_what_date_were_you_advised_of_the_redundancy_2321673'], #helpdesk_ticket_custom_field_cf_on_what_date_were_you_advised_of_the_redundancy_2321673",
        ).hide();
        $(
          "label[for='helpdesk_ticket_custom_field_cf_please_confirm_the_cause_of_death_2321673'],#helpdesk_ticket_custom_field_cf_please_confirm_the_cause_of_death_2321673",
        ).hide();
