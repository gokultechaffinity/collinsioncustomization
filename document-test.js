    ...
    let ticketDetails = function () {
      (function ($) {
        ...
        $(document).ready(function () {
          ...
          // Set an interval to regularly check for changes in the attachments list
          var checkDOMChanges = setInterval(function () {
            var currentAttachmentsList = $("#attachments_list").html();

            // Compare current state with previous state
            if (currentAttachmentsList !== previousAttachmentsList) {
              // Update the attachments list in the UI
              ...
              previousAttachmentsList = currentAttachmentsList;

              // Stop polling after the update
              clearInterval(checkDOMChanges);
            }
          }, 500);
