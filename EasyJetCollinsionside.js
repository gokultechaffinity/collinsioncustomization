...
jQuery(document).ready(function ($) {
  ...
  var german_titles = [
    ...
    "Ãœber dich",
    "Ãœber Ihre Reise",
    "ErzÃ¤hlen Sie uns, was passiert ist",
    "Ihre Dokumente",
  ...
  var french_titles = [
    "Votre police",
    "Ã€ propos de vous",
    "Ã€ propos de votre voyage",
    "Dites-nous ce qui s'est passÃ©",
    "Vos documents",
    "Vos dÃ©tails de paiement",
    "Votre rÃ©sumÃ© de rÃ©clamation",
  ];
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Appel API Ã©chouÃ©</div>'
      );
  ...
  if (
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Digite o cÃ³digo Captcha</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Introduzca el cÃ³digo Captcha</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Appel API Ã©chouÃ©</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Appel API Ã©chouÃ©</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Appel API Ã©chouÃ©</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Appel API Ã©chouÃ©</div>'
      );
  } else if (
    // (window.location.href == "https://easyjet.collinsoninsurance.com/en/support/tickets/51580")
    currentUrl.includes("/en/")
  ) {
    // (currentUrl.includes('https://easyjet.collinsoninsurance.com/en/support/tickets'))
    // English
    $(
      "#invalid-feedback helpdesk_ticket_custom_field_cf_reason_for_claim_2321673"
    )
  ...
  if ($("#new_helpdesk_ticket").length || $(".edit_helpdesk_ticket").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // Spanish
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encuentra la pÃ³liza</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encontrar a apÃ³lice</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >NÃ¤chster Abschnitt</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >Siguiente secciÃ³n</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >PrÃ³xima seÃ§Ã£o</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >NÃ¤chster Abschnitt</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/es/")) {
      ...
      // Spanish
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >Siguiente secciÃ³n</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/pt-PT/")) {
      ...
      // Portuguese
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >PrÃ³xima seÃ§Ã£o</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/fr/")) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">NÃ¤chster Abschnitt</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (
      ...
      // Spanish
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">Siguiente secciÃ³n</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (currentUrl.includes("/pt-PT/")) {
      ...
      // Portuguese
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">PrÃ³xima seÃ§Ã£o</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (currentUrl.includes("/fr/")) {
  ...
  if (jQuery(".fw-comments-wrapper").length > 0) {
    ...
    if (
      ...
      // German
      $(
        '<button class="save_and_continue5 btn btn-primary for-section-5 save_and_continue" type="button" >NÃ¤chster Abschnitt</button>'
      ).insertAfter(".attachments.for-section-5");
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button class="save_and_continue5 btn btn-primary for-section-5 save_and_continue" type="button" >Siguiente secciÃ³n</button>'
      ).insertAfter(".attachments.for-section-5");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button class="save_and_continue5 btn btn-primary for-section-5 save_and_continue" type="button" >PrÃ³xima seÃ§Ã£o</button>'
      ).insertAfter(".attachments.for-section-5");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >NÃ¤chster Abschnitt</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >SecciÃ³n siguiente</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >PrÃ³xima seÃ§Ã£o</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  if (currentUrl.includes("/it/")) {
    ...
    // (window.location.href == "https://easyjet.collinsoninsurance.com/en/support/tickets/new")
  ...
  var reasonForClaimObj = {
    "Any CANCELLATION claim due to COVID-19": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒ  di disdetta come la conferma della prenotazione per eventuale test Coronavirus e evidenza di esito positivo. ÃƒË† sufficiente solo la conferma tramite e-mail, non accettiamo la conferma tramite SMS.<br>",
    ...
    "Baggage - personal items damaged": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Certificazione, rilasciata da un professionista, che confermi il costo di riparabilitÃƒ  o la non riparabilitÃƒ  del bene.<br>",
    ...
    "Baggage - personal items lost or stolen": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Denuncia alle autoritÃƒ  locali che confermi gli eventi da cui ÃƒÂ¨ scaturito il sinistro.<br>Scontrino/ricevuta d'acquisto per il bene alla base del sinistro.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Baggage - suitcase hasn't arrived on time": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Il rapporto di irregolaritÃƒ  bagaglio rilasciato dal vettore.<br>Scontrino/ricevuta d'acquisto per il bene di prima necessitÃƒ .<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Cancelled trip - (NOT related to COVID-19)": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒ  di disdetta Documentazione che indichi la necessitÃƒ  di cancellare il viaggio es. Documentazione medica.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Curtailment Ã¢â‚¬â€œ returned home early": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Qualsiasi altro documento che sia rilevante per il tuo sinistro.<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Flight or Travel delayed": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÂ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Qualsiasi informazione che possa confermare la motivazione e la durata del ritardo di viaggio.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
